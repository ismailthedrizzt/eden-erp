...
export const PERMISSIONS = {
  ...
  automation: {
    ...
    viewRuns: 'automation.viewRuns',
  },
  aiCopilot: {
    use: 'aiCopilot.use',
    formAssist: 'aiCopilot.formAssist',
    documentIntelligence: 'aiCopilot.documentIntelligence',
    adminAssist: 'aiCopilot.adminAssist',
    viewHistory: 'aiCopilot.viewHistory',
    manageSettings: 'aiCopilot.manageSettings',
  },
  portal: {
    manageUsers: 'portal.manageUsers',
    inviteUsers: 'portal.inviteUsers',
