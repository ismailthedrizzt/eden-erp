...
export const representativesModule: ModuleContract = {
  ...
  actions: [
    { key: 'create_representative_draft', label: 'Temsilci taslagi olustur', actionType: 'create_draft', targetPage: '/app/sirket/companies/representatives', permission: 'representatives.edit' },
    ...
    { key: 'representative_suspend', label: 'Temsil yetkisini askiya alma', actionType: 'open_wizard', targetPage: '/app/sirket/companies/representatives', wizardKey: 'representative_suspend', permission: 'representatives.authority.update', fallbackPermission: 'representatives.edit', requiredRecordType: 'representative' },
