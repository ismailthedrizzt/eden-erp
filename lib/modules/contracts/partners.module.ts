...
export const partnersModule: ModuleContract = {
  ...
  actions: [
    ...
    { key: 'initial_partnership_entry', label: 'Ilk ortaklik girisi', actionType: 'open_wizard', targetPage: '/app/sirket/companies/partners', wizardKey: 'initial_partnership_entry', permission: 'partners.edit', requiredRecordType: 'partner' },
    { key: 'share_transfer', label: 'Pay devri', actionType: 'open_wizard', targetPage: '/app/sirket/companies/partners', wizardKey: 'share_transfer', permission: 'partners.edit', requiredRecordType: 'partner' },
    { key: 'ownership_exit', label: 'Ortakliktan cikis', actionType: 'open_wizard', targetPage: '/app/sirket/companies/partners', wizardKey: 'ownership_exit', permission: 'partners.edit', requiredRecordType: 'partner' },
    { key: 'ownership_correction', label: 'Ortaklik duzeltme kaydi', actionType: 'open_wizard', targetPage: '/app/sirket/companies/partners', wizardKey: 'ownership_correction', permission: 'partners.edit', requiredRecordType: 'partner' },
  ],
  projections: [
