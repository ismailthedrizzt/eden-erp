...
export const routeReleaseRegistry = [
  ...
  route('/app/development/temalarimiz', 'adminConsole', 'Temalarımız', 'development_internal', true, true, true, {
    ...
    notes: 'Development tenant only theme management surface with draft/import/export/activation lifecycle.',
  }),
  ...
  route('/app/sirket/companies/branches', 'branches', 'Subelerimiz', 'development', true, true, true),
  ...
  route('/app/sirket/tesisler', 'facilities', 'Tesisler/Lokasyonlar', 'development', true, true, true),
  route('/app/sirket/teskilat', 'organization', 'Teskilat/Kadro', 'development', true, true, true),
  ...
  route('/app/muhasebe/cari-hareketler', 'accounting', 'Cari Hareketler', 'development', true, true, true),
  route('/app/muhasebe/on-muhasebe-hareketleri', 'accounting', 'On Muhasebe Hareketleri', 'development', true, true, true),
  route('/app/muhasebe/banka-hesaplari-ve-kartlari', 'accounting', 'Banka Hesaplari ve Kartlari', 'development', true, true, true),
  route('/app/muhasebe/banka-kart-hareketleri', 'accounting', 'Banka Kart Hareketleri', 'development', true, true, true),
  route('/app/muhasebe/hesap-ve-kart-hareketleri', 'accounting', 'Hesap ve Kart Hareketleri', 'development', true, true, true),
  ...
  route('/app/sistem/temalar', 'adminConsole', 'Legacy visual themes route', 'hidden', false, false, false, { notes: 'Deprecated in favor of /app/development/temalarimiz.' }),
