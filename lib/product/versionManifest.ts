  ...
  modules: {
    ...
    after_sales: {
      ...
      pages: {
        ...
        bakim_planlari: {
          id: 'bakim_planlari',
          label: 'Bakim Planlari',
          href: '/app/satis-sonrasi/bakim-planlari',
          table: 'after_sales_maintenance_plans',
          version: '0.3.0',
          maturity: 'dev',
          requiredForSmallBusiness: false,
        },
        bakimi_gelenler: {
          id: 'bakimi_gelenler',
          label: 'Bakimi Gelenler',
          href: '/app/satis-sonrasi/bakimi-gelenler',
          table: 'after_sales_maintenance_due_items',
          version: '0.3.0',
          maturity: 'dev',
          requiredForSmallBusiness: false,
        },
        saha_gorevleri: {
          ...
          href: '/app/satis-sonrasi/saha-gorevleri',
          table: 'after_sales_field_assignments',
          version: '0.3.0',
          maturity: 'dev',
          requiredForSmallBusiness: false,
        },
        checklistler: {
          id: 'checklistler',
          label: 'Checklistler',
          href: '/app/satis-sonrasi/checklistler',
          table: 'after_sales_checklist_templates',
          version: '0.3.0',
          maturity: 'dev',
          requiredForSmallBusiness: false,
        },
    ...
    crm: {
      ...
      maturity: 'alpha',
      requiredForSmallBusiness: true,
      notes: 'Master kisi/kurum tekillestirme, musteri/tedarikci/lead paydas rolleri, cari kart ve takip gorevi baglantilari MVP seviyesine tasindi.',
      pages: {
        paydaslar: {
          id: 'paydaslar',
          label: 'Paydaslar',
          href: '/app/crm/paydaslar',
          table: 'crm_stakeholders',
          version: '0.2.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Master lookup ilk adim, duplicate uyarisi, cari kart olusturma, follow-up task ve iliskili roller paneli desteklenir.',
        },
      },
    },
    reporting: {
    ...
    sistem: {
      ...
      maturity: 'alpha',
      requiredForSmallBusiness: true,
      notes: 'Kullanici, rol, yetki matrisi, scope ve policy test yonetimi Security/RBAC moduluyle urunlestirildi.',
      pages: {
        admin_console: {
          id: 'admin_console',
          label: 'Admin Console',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Workspace settings, modul/feature flag yonetimi, health, outbox, entegrasyon ve teknik admin gorunumleri tek sayfa ailesinde toplandi.',
        },
        genel: {
          id: 'genel',
          label: 'Genel Ayarlar',
          href: '/app/sistem/genel',
        ...
        saglik: {
          ...
          href: '/app/sistem/saglik',
          table: 'integration_status_cache',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
        },
        ...
        entegrasyonlar: {
          ...
          href: '/app/sistem/entegrasyonlar',
          table: 'integration_status_cache',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
        ...
        teknik: {
          id: 'teknik',
          label: 'Teknik',
          href: '/app/sistem/teknik',
          table: 'worker_heartbeats',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: false,
          notes: 'Secret, token ve raw connection bilgisi gostermeden environment, versiyon ve deep health ozetleri system.admin icin sunulur.',
        },
        module_licenses: {
          id: 'module_licenses',
        ...
        kullanicilar: {
          ...
          table: 'security_users_profile',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Kullanici listesi, rol atama/kaldirma, sirket/sube scope yonetimi ve etkin izin ozeti Security API uzerinden calisir.',
        },
        roller: {
          id: 'roller',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Varsayilan rol seti, ozel rol olusturma ve permission matrix edit akisi urun seviyesine tasindi.',
        },
        yetkiler: {
          id: 'yetkiler',
          label: 'Yetki Matrisi',
          href: '/app/sistem/yetkiler',
          table: 'security_role_permissions',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Modul bazli permission x role matrisi, kritik yetki uyarilari ve policy test baglantisi hazirlandi.',
        },
        e_postalar: {
          id: 'e_postalar',
          label: 'Sistem E-postalari',
          href: '/app/sistem/e-postalar',
          table: 'email_messages',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Email queue, retry, test email ve admin izleme akisi Notification domain uzerinden calisir.',
        },
        veri_kalitesi: {
          id: 'veri_kalitesi',
          label: 'Veri Kalitesi',
          href: '/app/sistem/veri-kalitesi',
          table: 'data_quality_findings',
          version: '0.1.0',
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Duplicate review queue, kalite skorlari, merge preview/guard ve Action Center kalite uyarilari Data Quality domain uzerinden calisir.',
        },
        loglar: {
          id: 'loglar',
    ...
    notifications: {
      ...
      maturity: 'alpha',
      requiredForSmallBusiness: true,
      notes: 'Uygulama ici bildirim, hatirlatma, email queue, preferences, outbox mapping ve Action Center ayrimi MVP seviyesine tasindi.',
      pages: {
        settings: {
          id: 'settings',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Notification listesi, okunmamis sayac, read/dismiss/archive, preference formu ve hatirlatma listesi vardir.',
        },
        system_emails: {
          id: 'system_emails',
          label: 'Sistem E-postalari',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Admin email queue gorunumu, failed retry ve test email queue akisi desteklenir.',
        },
      },
    },
    search: {
      ...
      maturity: 'alpha',
      requiredForSmallBusiness: true,
      notes: 'Ctrl/Cmd+K command palette, gruplu arama sonuclari, action eligibility ve son acilanlar MVP seviyesine tasindi.',
      pages: {
        command_palette: {
          id: 'command_palette',
          label: 'Komut Paleti',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Kayit, islem, belge, rapor, ayar ve yardim sonuclari permission/scope kontrollu arama providerlariyla gelir.',
        },
      },
    },
    dataQuality: {
      ...
      maturity: 'alpha',
      requiredForSmallBusiness: true,
      notes: 'Master data governance, duplicate detection, review queue, merge preview, quality scores ve findings MVP seviyesine tasindi.',
      pages: {
        dashboard: {
          id: 'dashboard',
          label: 'Veri Kalitesi',
          ...
          maturity: 'alpha',
          requiredForSmallBusiness: true,
          notes: 'Summary cards, duplicate queue, merge preview, findings, score badges ve rule listesi vardir.',
        },
      },
    },
    uretim: {
