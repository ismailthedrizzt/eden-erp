  ...
  opening: createLifecycleWizardTemplate({
    ...
    completion: {
      formWrites: [
        ...
        lifecycleFieldWrite('trade_registry_number', 'trade_registry_number', { label: 'Ticaret Sicil No' }),
        lifecycleFieldWrite('mersis_number', 'mersis_number', { label: 'MERSİS No' }),
        lifecycleFieldWrite('tax_number', 'tax_number', { label: 'VKN' }),
        lifecycleFieldWrite('tax_office', 'tax_office', { label: 'Vergi Dairesi' }),
        lifecycleFieldWrite('sgk_workplace_registry_no', 'sgk_workplace_registry_no', { label: 'SGK İşyeri Sicil No' }),
