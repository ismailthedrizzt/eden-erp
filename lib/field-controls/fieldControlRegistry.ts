...
const companyControls: FieldControlDefinition[] = [
  ...
  controlled('company', 'short_name', 'Kisa unvan', operations.titleChange),
  ...
  controlled('company', 'country', 'Ulke', operations.addressChange),
  controlled('company', 'city', 'Il', operations.addressChange),
  controlled('company', 'district', 'Ilce', operations.addressChange),
  ...
  controlled('company', 'postal_code', 'Posta kodu', operations.addressChange),
  ...
  controlled('company', 'nace_codes', 'NACE kodlari', operations.naceChange),
  relation('company', 'company_nace_codes', 'NACE kodlari', operations.naceChange),
  controlled('company', 'risk_class', 'Tehlike sinifi', operations.naceChange),
  controlled('company', 'activity_subject', 'Faaliyet konusu', operations.activitySubjectChange),
...
const partnerControls: FieldControlDefinition[] = [
  ...
  ...controlledFields('company_partner', [
    ...
    suggestedOperations: [
      ...
      op('share_transfer', 'Pay Devri', 'share_transfer', TARGETS.partners),
      operations.capitalIncrease,
      op('ownership_correction', 'Duzeltme Kaydi', 'ownership_correction', TARGETS.partners),
    ],
  }),
