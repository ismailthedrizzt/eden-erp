...
export const actionGuideDefinitions: ActionGuideDefinition[] = [
  defineAction({
    ...
    label: 'Nasil Baslayacagimi Goster',
    description: 'Yeni calisma alaninda ilk sirket, modul kontrolu, tur ve Action Center adimlari Baslangic Merkezinde takip edilir.',
    moduleKey: 'settings',
    domain: 'onboarding',
    actionType: 'navigate',
    ...
    intentExamples: ['nasil baslayacagim', 'ilk olarak ne yapmaliyim', 'eden erpye yeni basladim', 'calisma alanim hazir mi', 'baslangic adimlari'],
    keywords: ['basla', 'baslangic', 'ilk', 'onboarding', 'hazir', 'kurulum'],
    steps: [
      'Baslangic Merkezini acin.',
      'Calisma alani profilini ve modul paketlerini kontrol edin.',
      'Ilk sirket taslagini olusturup Sirket Acilisi sihirbaziyla aktif hale getirin.',
    ],
    helpText: 'Ilk giriste teknik ayarlar yerine siradaki is adimlari gosterilir.',
  }),
  defineAction({
