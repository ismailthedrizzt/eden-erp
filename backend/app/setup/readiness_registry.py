...
READINESS_REGISTRY: dict[str, ModuleReadinessDefinition] = {
    ...
    "hr": ModuleReadinessDefinition(
        ...
        setup_steps=[
            ...
            "Create leave, attendance, work schedule, timesheet and payroll preparation tables for HR deepening.",
    ...
    "automation": ModuleReadinessDefinition(
        ...
        setup_steps=[
            "Create automation rule, run log, template, and action result tables.",
            "Verify registry-constrained triggers, conditions, and action templates.",
            "Wire worker, outbox handler, notification/task integrations, permissions, and audit logging.",
        ],
    ),
    "aiCopilot": ModuleReadinessDefinition(
        ...
        setup_steps=[
            "Create AI Copilot history, feedback, and document intelligence result tables.",
            "Verify provider configuration or deterministic local fallback.",
            "Verify registry-constrained action resolver, permission/scope masking, and no-mutation action preview.",
        ],
    ),
    "customerPortal": ModuleReadinessDefinition(
        ...
        setup_steps=[
            "Create portal external user, invitation, shared document, and activity log tables.",
            "Verify portal auth dependency is separate from internal ERP permissions.",
