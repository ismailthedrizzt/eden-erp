...
REPORT_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "followup_due_report": {
        "title": "CRM takip raporu",
        "module_key": "crm",
        "permission": "crm.followupManage",
        "table": "public.crm_followup_events",
        "columns": [
            "id",
            "company_id",
            "entity_type",
    ...
    "won_lost_report": {
        "title": "Kazanilan/Kaybedilen firsat raporu",
        "module_key": "crm",
        "permission": "crm.opportunitiesView",
        "table": "public.crm_opportunities",
        "columns": [
        ...
        "sort": "actual_close_date",
        "extra_where": "status in ('won','lost')",
    },
    "lead_source_report": {
        ...
        "permission": "crm.leadsView",
        "table": "public.crm_leads",
        "columns": ["id", "company_id", "lead_name", "source", "lead_status", "estimated_value", "created_at"],
        "sort": "created_at",
    },
    "owner_performance_report": {
        "title": "CRM sorumlu performansi",
        "module_key": "crm",
        "permission": "crm.opportunitiesView",
        "table": "public.crm_opportunities",
        "columns": [
    ...
    "operations_risk_report": {
        "title": "Operasyon risk raporu",
        "module_key": "system",
        "permission": "reporting.viewSystem",
        "table": "public.operation_requests",
        "columns": ["id", "company_id", "module_key", "operation_type", "operation_status", "created_at"],
        "sort": "created_at",
        "extra_where": "operation_status in ('failed','requires_action','stuck')",
    },
    "financial_document_gap_report": {
        "title": "Finansal belge eksikligi raporu",
        "module_key": "accounting",
        "permission": "accounting.view",
        "table": "public.accounting_cari_transactions",
        "columns": ["id", "company_id", "account_id", "transaction_date", "amount", "document_status", "reconciliation_status"],
        "sort": "transaction_date",
        "extra_where": "document_status = 'document_needed' or reconciliation_status in ('unmatched','needs_review')",
    },
    "authority_expiry_report": {
        "title": "Yetki sureleri raporu",
        "module_key": "representatives",
        "permission": "representatives.view",
        "table": "public.v_current_representative_authorities",
        "columns": ["company_id", "representative_id", "authority_status", "scope_type", "valid_until"],
        "sort": "valid_until",
    ...
    "service_operations_report": {
        ...
        "permission": "afterSales.fieldServiceView",
        "table": "public.after_sales_service_requests",
        "columns": ["id", "company_id", "request_no", "status", "priority", "due_date", "assigned_technician_user_id"],
        "sort": "due_date",
    },
    "hr_readiness_report": {
        "title": "HR hazirlik raporu",
        "module_key": "hr",
        "permission": "hr.view",
        "table": "public.hr_employees",
        "columns": ["id", "company_id", "employee_no", "full_name", "record_status", "employment_status", "sgk_status"],
        "sort": "updated_at",
    },
}
