...
DOCUMENT_TYPES: tuple[DocumentTypeDefinition, ...] = (
    ...
    DocumentTypeDefinition("employee.employment_contract", "Is Sozlesmesi", "hr", "hr"),
    DocumentTypeDefinition("ownership.partnership_entry_document", "Ortaklik Giris Belgesi", "ownership", "ownership"),
    ...
    DocumentTypeDefinition("capital.payment_evidence", "Odeme Kaniti", "capital", "capital"),
    ...
    DocumentTypeDefinition("representative.limit_change_document", "Yetki Limit Degisikligi Belgesi", "representatives", "representative"),
    ...
    DocumentTypeDefinition("branch.lease_or_usage_document", "Kira/Kullanim Belgesi", "branches", "branch"),
    ...
    DocumentTypeDefinition("accounting.expense_document", "Gider Belgesi", "accounting", "accounting"),
    DocumentTypeDefinition("accounting.reconciliation_document", "Mutabakat Belgesi", "accounting", "accounting"),
    ...
    DocumentTypeDefinition("service.customer_signature", "Musteri Imzasi", "after_sales", "after_sales"),
    DocumentTypeDefinition("service.warranty_document", "Garanti Belgesi", "after_sales", "after_sales"),
    DocumentTypeDefinition("contract.signed_contract", "Imzali Sozlesme", "contracts", "contract"),
    DocumentTypeDefinition("contract.draft_contract", "Taslak Sozlesme", "contracts", "contract"),
