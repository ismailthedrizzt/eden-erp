...
PERMISSIONS: dict[str, PermissionContract] = {
    ...
    "accounting.bankAccountsView": _permission("accounting.bankAccountsView", "Banka hesaplarini goruntule", "accounting", "finance", "view", fallback=["accounting.view"]),
    "accounting.bankAccountsEdit": _permission("accounting.bankAccountsEdit", "Banka hesaplarini duzenle", "accounting", "finance", "edit", fallback=["accounting.edit"]),
    "accounting.bankTransactionsView": _permission("accounting.bankTransactionsView", "Banka/kart hareketlerini goruntule", "accounting", "finance", "view", fallback=["accounting.view"]),
    "accounting.bankTransactionsImport": _permission("accounting.bankTransactionsImport", "Banka/kart hareketi import et", "accounting", "finance", "operation", fallback=["accounting.edit"]),
    "accounting.eDocumentsView": _permission("accounting.eDocumentsView", "E-belgeleri goruntule", "accounting", "finance", "view", fallback=["accounting.view"]),
    "accounting.eDocumentsImport": _permission("accounting.eDocumentsImport", "E-belge import et", "accounting", "finance", "operation", fallback=["accounting.edit"]),
    "accounting.reconciliationView": _permission("accounting.reconciliationView", "Mutabakat ekranlarini goruntule", "accounting", "finance", "view", fallback=["accounting.view"]),
    "accounting.reconciliationManage": _permission("accounting.reconciliationManage", "Mutabakat eslestirmelerini yonet", "accounting", "finance", "operation", fallback=["accounting.reconcile", "accounting.edit"]),
    "accounting.capitalReconciliationView": _permission("accounting.capitalReconciliationView", "Sermaye mutabakatini goruntule", "accounting", "finance", "view", fallback=["accounting.view"]),
    "accounting.capitalReconciliationManage": _permission("accounting.capitalReconciliationManage", "Sermaye odeme mutabakati yap", "accounting", "finance", "operation", fallback=["accounting.reconciliationManage"]),
    ...
    "hr.leaveView": _permission("hr.leaveView", "Izinleri goruntule", "hr", "hr", "view", fallback=["hr.view"]),
    "hr.leaveRequestCreate": _permission("hr.leaveRequestCreate", "Izin talebi olustur", "hr", "hr", "operation", fallback=["hr.leaveView"]),
    "hr.leaveApprove": _permission("hr.leaveApprove", "Izin talebi onayla", "hr", "hr", "approval", fallback=["hr.leaveAdmin"]),
    "hr.leaveAdmin": _permission("hr.leaveAdmin", "Izin politikasini yonet", "hr", "hr", "admin", fallback=["hr.edit"]),
    "hr.attendanceView": _permission("hr.attendanceView", "Devam-devamsizlik goruntule", "hr", "hr", "view", fallback=["hr.view"]),
    "hr.attendanceEdit": _permission("hr.attendanceEdit", "Devam-devamsizlik duzenle", "hr", "hr", "operation", fallback=["hr.edit"]),
    "hr.timesheetView": _permission("hr.timesheetView", "Puantaj goruntule", "hr", "hr", "view", fallback=["hr.attendanceView"]),
    "hr.timesheetManage": _permission("hr.timesheetManage", "Puantaj yonet", "hr", "hr", "operation", fallback=["hr.attendanceEdit"]),
    "hr.timesheetApprove": _permission("hr.timesheetApprove", "Puantaj onayla", "hr", "hr", "approval", fallback=["hr.timesheetManage"]),
    "hr.payrollPrepView": _permission("hr.payrollPrepView", "Bordro hazirligi goruntule", "hr", "hr", "view", fallback=["hr.timesheetView"]),
    "hr.payrollPrepManage": _permission("hr.payrollPrepManage", "Bordro hazirligini yonet", "hr", "hr", "operation", fallback=["hr.timesheetApprove"]),
    ...
    "afterSales.maintenanceView": _permission("afterSales.maintenanceView", "Bakim planlarini goruntule", "after_sales", "service", "view", fallback=["afterSales.view"]),
    "afterSales.maintenanceManage": _permission("afterSales.maintenanceManage", "Bakim planlarini yonet", "after_sales", "service", "operation", fallback=["afterSales.edit"]),
    "afterSales.fieldServiceView": _permission("afterSales.fieldServiceView", "Saha servis gorevlerini goruntule", "after_sales", "service", "view", fallback=["afterSales.view"]),
    "afterSales.fieldServiceAssign": _permission("afterSales.fieldServiceAssign", "Saha servis teknisyeni ata", "after_sales", "service", "operation", fallback=["afterSales.requestAssign"]),
    "afterSales.fieldServiceExecute": _permission("afterSales.fieldServiceExecute", "Saha servis akisini yurut", "after_sales", "service", "operation", fallback=["afterSales.serviceComplete"]),
    "afterSales.checklistManage": _permission("afterSales.checklistManage", "Servis checklistlerini yonet", "after_sales", "service", "operation", fallback=["afterSales.edit"]),
    "afterSales.serviceReportView": _permission("afterSales.serviceReportView", "Servis raporunu goruntule", "after_sales", "service", "view", fallback=["afterSales.view"]),
    "afterSales.serviceReportGenerate": _permission("afterSales.serviceReportGenerate", "Servis raporu uret", "after_sales", "service", "operation", fallback=["afterSales.serviceComplete"]),
    "afterSales.warrantyOverride": _permission("afterSales.warrantyOverride", "Garanti durumunu override et", "after_sales", "service", "operation", fallback=["afterSales.admin"]),
    ...
    "crm.leadsView": _permission("crm.leadsView", "Lead kayitlarini goruntule", "crm", "lead", "view", fallback=["crm.view"]),
    "crm.leadsEdit": _permission("crm.leadsEdit", "Lead kayitlarini duzenle", "crm", "lead", "edit", fallback=["crm.leadsManage", "crm.edit"]),
    "crm.leadsConvert": _permission("crm.leadsConvert", "Lead'i musteri/firsata donustur", "crm", "lead", "operation", fallback=["crm.leadsEdit"]),
    "crm.opportunitiesView": _permission("crm.opportunitiesView", "Firsatlari goruntule", "crm", "opportunity", "view", fallback=["crm.view"]),
    "crm.opportunitiesEdit": _permission("crm.opportunitiesEdit", "Firsatlari duzenle", "crm", "opportunity", "edit", fallback=["crm.edit"]),
    "crm.opportunityStageChange": _permission("crm.opportunityStageChange", "Firsat asamasini degistir", "crm", "opportunity", "operation", fallback=["crm.opportunitiesEdit"]),
    "crm.opportunityWinLoss": _permission("crm.opportunityWinLoss", "Firsati kazanildi/kaybedildi isaretle", "crm", "opportunity", "approval", fallback=["crm.opportunityStageChange"]),
    "crm.pipelineManage": _permission("crm.pipelineManage", "CRM pipeline asamalarini yonet", "crm", "pipeline", "admin", fallback=["crm.opportunitiesEdit"]),
    "crm.followupManage": _permission("crm.followupManage", "CRM takip gorevlerini yonet", "crm", "followup", "operation", fallback=["crm.createTask", "crm.opportunitiesEdit"]),
    "crm.proposalManage": _permission("crm.proposalManage", "CRM teklif baglantilarini yonet", "crm", "proposal", "operation", fallback=["crm.opportunitiesEdit", "documents.upload"]),
