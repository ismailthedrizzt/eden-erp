...
PERMISSIONS: dict[str, PermissionContract] = {
    ...
    "reporting.savedViewsManage": _permission("reporting.savedViewsManage", "Kayitli rapor gorunumlerini yonet", "reporting", "saved_view", "operation", fallback=["reporting.view"]),
    "reporting.customReportsManage": _permission("reporting.customReportsManage", "Ozel rapor tanimlarini yonet", "reporting", "custom_report", "operation", fallback=["reporting.admin"]),
    "reporting.scheduledReportsManage": _permission("reporting.scheduledReportsManage", "Zamanlanmis raporlari yonet", "reporting", "scheduled_report", "operation", fallback=["reporting.admin"]),
    "reporting.exportManage": _permission("reporting.exportManage", "Rapor export joblarini yonet", "reporting", "export", "operation", fallback=["reporting.export"]),
    "reporting.dashboardCustomize": _permission("reporting.dashboardCustomize", "Dashboard kisisellestir", "reporting", "dashboard", "operation", fallback=["reporting.dashboardView"]),
    "automation.view": _permission("automation.view", "Otomasyon kurallarini goruntule", "automation", "automation", "view", fallback=["settings.view"]),
    "automation.create": _permission("automation.create", "Otomasyon kurali olustur", "automation", "automation", "operation", fallback=["automation.edit"]),
    "automation.edit": _permission("automation.edit", "Otomasyon kurallarini duzenle", "automation", "automation", "edit", fallback=["automation.view"]),
    "automation.activate": _permission("automation.activate", "Otomasyon kurali aktiflestir/duraklat", "automation", "automation", "approval", fallback=["automation.admin"]),
    "automation.run": _permission("automation.run", "Otomasyon kurali calistir veya simule et", "automation", "automation", "operation", fallback=["automation.view"]),
    "automation.admin": _permission("automation.admin", "Otomasyon yoneticisi", "automation", "automation", "admin", fallback=["system.admin", "settings.edit"]),
    "automation.viewRuns": _permission("automation.viewRuns", "Otomasyon calisma loglarini goruntule", "automation", "automation", "view", fallback=["automation.view"]),
    "aiCopilot.use": _permission("aiCopilot.use", "AI Copilot kullan", "aiCopilot", "assistant", "view", fallback=["settings.view"]),
    "aiCopilot.formAssist": _permission("aiCopilot.formAssist", "AI form onerilerini kullan", "aiCopilot", "assistant", "operation", fallback=["aiCopilot.use"]),
    "aiCopilot.documentIntelligence": _permission("aiCopilot.documentIntelligence", "AI belge zekasini kullan", "aiCopilot", "assistant", "operation", fallback=["aiCopilot.use", "documents.view"]),
    "aiCopilot.adminAssist": _permission("aiCopilot.adminAssist", "AI admin yardimini kullan", "aiCopilot", "assistant", "admin", fallback=["adminConsole.view", "settings.view"]),
    "aiCopilot.viewHistory": _permission("aiCopilot.viewHistory", "AI Copilot gecmisini goruntule", "aiCopilot", "assistant", "view", fallback=["aiCopilot.use"]),
    "aiCopilot.manageSettings": _permission("aiCopilot.manageSettings", "AI Copilot ayarlarini yonet", "aiCopilot", "assistant", "admin", fallback=["system.admin", "settings.edit"]),
    "portal.manageUsers": _permission("portal.manageUsers", "Musteri portali kullanicilarini yonet", "customerPortal", "portal", "admin", fallback=["system.admin", "crm.edit"]),
    "portal.inviteUsers": _permission("portal.inviteUsers", "Musteri portali kullanicisi davet et", "customerPortal", "portal", "operation", fallback=["portal.manageUsers", "crm.edit"]),
    "portal.suspendUsers": _permission("portal.suspendUsers", "Musteri portali kullanicisini askiya al", "customerPortal", "portal", "admin", fallback=["portal.manageUsers"]),
    "portal.viewActivity": _permission("portal.viewActivity", "Musteri portali erisim izlerini goruntule", "customerPortal", "portal", "view", fallback=["portal.manageUsers", "audit.view"]),
    "portal.shareDocuments": _permission("portal.shareDocuments", "Belgeleri musteri portaliyla paylas", "customerPortal", "portal", "operation", fallback=["documents.upload", "portal.manageUsers"]),
    "integrations.view": _permission("integrations.view", "Entegrasyonlari goruntule", "integrations", "integration", "view", fallback=["adminConsole.view", "settings.view"]),
    "integrations.manageApps": _permission("integrations.manageApps", "Integration app kayitlarini yonet", "integrations", "integration", "admin", fallback=["integrations.view", "adminConsole.manage"]),
    "integrations.manageCredentials": _permission("integrations.manageCredentials", "Entegrasyon credential ve secret rotasyonunu yonet", "integrations", "credential", "admin", fallback=["integrations.manageApps"]),
    "integrations.manageWebhooks": _permission("integrations.manageWebhooks", "Webhook aboneliklerini yonet", "integrations", "webhook", "operation", fallback=["integrations.manageApps"]),
    "integrations.viewDeliveries": _permission("integrations.viewDeliveries", "Webhook teslimatlarini goruntule", "integrations", "webhook", "view", fallback=["integrations.view"]),
    "integrations.retryDelivery": _permission("integrations.retryDelivery", "Webhook teslimatini tekrar dene", "integrations", "webhook", "operation", fallback=["integrations.viewDeliveries", "integrations.manageWebhooks"]),
    "integrations.viewInbound": _permission("integrations.viewInbound", "Inbound webhook olaylarini goruntule", "integrations", "inbound", "view", fallback=["integrations.view"]),
    "integrations.processInbound": _permission("integrations.processInbound", "Inbound webhook olaylarini isle", "integrations", "inbound", "operation", fallback=["integrations.viewInbound", "integrations.manageApps"]),
    "integrations.admin": _permission("integrations.admin", "Integration Hub yoneticisi", "integrations", "integration", "admin", fallback=["system.admin", "adminConsole.manage"]),
