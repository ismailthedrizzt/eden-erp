...
Both environments run the same `main` code. The active Supabase project is selected only by environment variables.
...
- Keep Development Supabase credentials out of the Virtual Server live env file.
