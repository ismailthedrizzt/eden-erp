...
Historical note: this report was written for the previous `develop`/Vercel promotion model. The active model is now single `main` branch plus local Development Supabase and Virtual Server Release Supabase. See `docs/deployment/SingleMainVirtualServerDeployment.md`.
