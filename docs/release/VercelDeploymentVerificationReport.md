...
Historical note: this report was written for the previous Vercel deployment plan. The active live deployment target is now a Virtual Server pulling `origin/main`. See `docs/deployment/SingleMainVirtualServerDeployment.md`.
