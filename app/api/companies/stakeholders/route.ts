...
// TARGET_FASTAPI_ENDPOINT: /api/v1/crm/stakeholders
...
const handler = createFastApiProxyHandler('/api/v1/crm/stakeholders')
...
export async function GET(request: NextRequest) {
  ...
  const response = await proxyToFastApi(request, '/api/v1/crm/stakeholders', {
    internal: true,
