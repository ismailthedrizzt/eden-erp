...
const EmployeeUpdateSchema = z.object({
  ...
  sgk_giris_yontemi: z.enum(['servis', 'web']).optional(),
  sgk_giris_referans_no: z.string().optional(),
  sgk_giris_bildiren: z.string().optional(),
  sgk_giris_sigorta_kolu: z.string().optional(),
  sgk_giris_gorev_kodu: z.string().optional(),
  sgk_giris_meslek_kodu: z.string().optional(),
  sgk_giris_csgb_is_kolu: z.string().optional(),
  sgk_giris_engelli: z.enum(['E', 'H']).optional(),
  sgk_giris_eski_hukumlu: z.enum(['E', 'H']).optional(),
  sgk_giris_ogrenim_kodu: z.string().optional(),
  sgk_giris_mezuniyet_yili: z.string().optional(),
  sgk_giris_mezuniyet_bolumu: z.string().optional(),
  sgk_giris_kismi_gun_sayisi: z.string().optional(),
  sgk_cikis_yontemi: z.enum(['servis', 'web']).optional(),
  sgk_cikis_referans_no: z.string().optional(),
  sgk_cikis_bildiren: z.string().optional(),
  sgk_cikis_nedeni: z.string().optional(),
  sgk_cikis_meslek_kodu: z.string().optional(),
  sgk_cikis_csgb_is_kolu: z.string().optional(),
  sgk_cikis_ucret_yuzde_usulu: z.enum(['E', 'H']).optional(),
  sgk_cikis_onceki_belge_turu: z.string().optional(),
  sgk_cikis_onceki_hakedilen_ucret: z.string().optional(),
  sgk_cikis_bu_donem_belge_turu: z.string().optional(),
  sgk_cikis_bu_donem_hakedilen_ucret: z.string().optional(),
...
const employeeSgkColumns = [
  'sgk_giris_yontemi',
  'sgk_giris_referans_no',
  'sgk_giris_bildiren',
  'sgk_giris_sigorta_kolu',
  'sgk_giris_gorev_kodu',
  'sgk_giris_meslek_kodu',
  'sgk_giris_csgb_is_kolu',
  'sgk_giris_engelli',
  'sgk_giris_eski_hukumlu',
  'sgk_giris_ogrenim_kodu',
  'sgk_giris_mezuniyet_yili',
  'sgk_giris_mezuniyet_bolumu',
  'sgk_giris_kismi_gun_sayisi',
  'sgk_cikis_yontemi',
  'sgk_cikis_referans_no',
  'sgk_cikis_bildiren',
  'sgk_cikis_nedeni',
  'sgk_cikis_meslek_kodu',
  'sgk_cikis_csgb_is_kolu',
  'sgk_cikis_ucret_yuzde_usulu',
  'sgk_cikis_onceki_belge_turu',
  'sgk_cikis_onceki_hakedilen_ucret',
  'sgk_cikis_bu_donem_belge_turu',
  'sgk_cikis_bu_donem_hakedilen_ucret',
]
