...
// TARGET_FASTAPI_ENDPOINT: /api/v1/accounting/bank-transactions/{id}/match
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const response = await proxyToFastApi(request, `/api/v1/accounting/bank-transactions/${id}/match`)
