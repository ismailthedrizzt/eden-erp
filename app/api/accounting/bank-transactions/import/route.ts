...
// TARGET_FASTAPI_ENDPOINT: /api/v1/accounting/bank-transactions/import
...
export async function POST(request: NextRequest) {
  const response = await proxyToFastApi(request, '/api/v1/accounting/bank-transactions/import')
