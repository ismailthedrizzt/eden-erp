...
// TARGET_FASTAPI_ENDPOINT: /api/v1/accounting/reconciliation/suggestions
...
export async function GET(request: NextRequest) {
  const response = await proxyToFastApi(request, '/api/v1/accounting/reconciliation/suggestions')
