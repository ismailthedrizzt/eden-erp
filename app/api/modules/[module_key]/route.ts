...
// TARGET_FASTAPI_ENDPOINT: /api/v1/modules/{module_key}
// NOTES: Module detail and activation are BFF proxy-only surfaces.
...
export async function GET(
  ...
  const response = await proxyToFastApi(request, `/api/v1/modules/${moduleKey}`)
