...
// TARGET_FASTAPI_ENDPOINT: /api/v1/action-center/summary
// NOTES: Action Center summary belongs in Python; TS remains fallback only.
...
export async function GET(request: NextRequest) {
  const fastApiResponse = await proxyToFastApi(request, '/api/v1/action-center/summary')
